...
function addon.tcr:SetupConversionFactors()
...
addon.tcr.TertiaryStatBrackets = {
	{["size"]=10,["penalty"]=0},
	{["size"]=5,["penalty"]=0.2},
	{["size"]=5,["penalty"]=0.4},
	{["size"]=80,["penalty"]=0.6},
...
function addon.tcr:GetStatDiminishBracket(statId,amount)
	...
	local stat_bracket = addon.tcr[stat.bracket];
...
function addon.tcr:RecalculateTrueCombatRatings() 
